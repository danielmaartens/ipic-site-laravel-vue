<template>
    <div class="container">
        <div class="clear-left">
            <img class="right content-logo" src="images/logos/ipic_group.gif">
            <h2>Group Overview</h2>
        <h3 class="headings">Vision</h3>
        <p class="content">We compound wealth to help others to be and to make heroes.</p>
        <h3 class="headings">Mission</h3>
        <p class="content">To compound sustainable property-related income-streams by actively managing, enhancing and developing investment properties.</p>
        </div>

        <h3>Goals</h3>
        <ul>
            <li>To outperform the average return of the listed property sector operating in South Africa.</li>
            <li>To donate at least R1,000,000 per year.</li>
            <li>To be a catalyst between Donors and Beneficiaries.</li>
        </ul>
